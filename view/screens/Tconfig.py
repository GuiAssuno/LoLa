...
TelaConfig: configuracoes gerais do app (apenas UI - sem logica).
...
from view.widgets.botao_navegacao import IconButton


class TelaConfig(BaseScreen):

    save_requested = Signal(dict)

    def __init__(self, parent=None):
        super().__init__(title="CONFIGURACOES", show_back=True, parent=parent)
        self.setObjectName("TelaConfig")
